    ...
    <div className="mx-auto flex h-dvh w-full max-w-2xl flex-col px-4 pt-4">
      <header className="mb-4 flex items-center gap-3 border-b border-zinc-200 pb-4 dark:border-zinc-800">
        <button
          ...
          className="flex size-9 items-center justify-center rounded-full border border-zinc-300 text-lg transition-colors hover:bg-zinc-100 dark:border-zinc-700 dark:hover:bg-zinc-800"
        >
          ←
        </button>
